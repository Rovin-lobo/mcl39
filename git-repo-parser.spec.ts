...
describe('GitRepoParser', () => {
  describe('parse', () => {
    ...
    it('should handle GitHub API rate limit errors', async () => {
      ...
      await expect(GitRepoParser.parse('https://github.com/user/repo'))
    ...
    it('should handle repository not found errors', async () => {
      ...
      await expect(GitRepoParser.parse('https://github.com/user/nonexistent'))
        .rejects.toThrow('Repository not found');
    });

    it('should handle invalid token format', async () => {
      await expect(GitRepoParser.parse('https://github.com/user/repo', { authToken: 'invalid_token' }))
